    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../index.html"><span style="color: #293339;">Not</span><span style="color: #0073CF;">Tri</span><span style="color: #F48F00;">va</span><span style="color: #C94A38;">go</span>: admin</a>
        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><a href="">Hoteleros</a></li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h1 class="page-header">Usuarios: Hoteleros</h1>
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <form class="form-inline col-sm-7 col-sm-offset-1" id="div-agregar" style="display: none;">
                            ...
                            <button type="button" class="btn btn-default" id="btn-guardar" value="2">
