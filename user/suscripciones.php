    ...
    <div class="container-fluid container-fluid-fix">
      ...
      <div class="row row-margin-fix">
        ...
        <div id="contenido-pagina" class="col-sm-9 col-md-10 col-lg-10 main">
          <h1 class="titulo-cuenta page-header">Subscripciones</h1>

          <div class="row placeholders">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left">

              <div class="envoltura-contenedor-subscripcones">
                <div class="contenedor-susbcripciones">
                  <h3 class="titulo-subscripcones">Boletines de noticias</h3>
                  <div>
                    <input type="checkbox" name="chk-" value="">    Recibir el boletín de noticias de trivago
                  </div>
                </div>
              </div>
